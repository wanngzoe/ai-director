...
function Dashboard() {
  ...
  const platformUpdates = [
    ...
    { id: 7, version: '新功能', title: 'AI导演工作流测试', desc: '剧本→分镜→提示词 三阶段测试工具', date: '常驻', category: 'feature', link: '/ai-workflow' },
  ]
          ...
          <>
            ...
            <section className="project-list">
              ...
              <div className="projects-grid">
                <div className="project-card" onClick={() => navigate(`/project/${sampleProject.id}`)} style={{ cursor: 'pointer' }}>
                  ...
                  <button className="more-btn" onClick={(e) => { e.stopPropagation() }}><MoreVertical size={16} /></button>
                </div>
              </div>
            </section>
            ...
            <section className="quick-entry" style={{ marginTop:32 }}>
              ...
              <div className="quick-cards">
                ...
                <Link to="/project/1?module=casting" className="quick-card">
                  <Users size={32} />
                  <span>选角中心</span>
                </Link>
                <Link to="/project/1?module=scene" className="quick-card">
                  <Image size={32} />
                  <span>场景工坊</span>
                </Link>
...
function ProjectWorkspace() {
  const { id } = useParams()
  const navigate = useNavigate()
  const [activeModule, setActiveModule] = useState('casting')

  // Project list - all share same data for demo
  const projects = [
    { id: '1', title: '霸总甜妻', status: 'storyboard' },
    { id: '2', title: '都市丽人', status: 'casting' },
    { id: '3', title: '重生千金', status: 'scene' },
  ]
  const currentProject = projects.find(p => p.id === id) || projects[0]

  const modules = [
    { id: 'script', label: '剧本', icon: <FileText size={18} /> },
    { id: 'casting', label: '选角', icon: <Users size={18} /> },
    { id: 'scene', label: '场景', icon: <Image size={18} /> },
    { id: 'props', label: '道具', icon: <Package size={18} /> },
    { id: 'storyboard', label: '分镜', icon: <Clapperboard size={18} /> },
    { id: 'post', label: '后期', icon: <Scissors size={18} /> },
    { id: 'output', label: '成片', icon: <Play size={18} /> },
  ]
        ...
        return (
          <div className="module-content">
            ...
            <div className="card" style={{ padding: 24 }}>
              <h3>{currentProject.title} - 剧本内容</h3>
              <p style={{ color: 'var(--text-muted)', marginTop: 8 }}>剧本管理编辑页面，内容与剧本工坊同步</p>
              <div style={{ marginTop: 24, padding: 16, background: 'var(--bg-input)', borderRadius: 8 }}>
                <p style={{ lineHeight: 1.8 }}>第1集：初次相遇</p>
                <p style={{ lineHeight: 1.8, marginTop: 12 }}>[第一场] 总裁办公室-夜</p>
                <p style={{ lineHeight: 1.8 }}>林婉儿站在落地窗前，手握文件，背对着门...</p>
              </div>
              <button className="btn btn-primary" style={{ marginTop: 16 }} onClick={() => navigate('/script-studio')}>
                打开剧本工坊
              </button>
            </div>
          </div>
      ...
      case 'casting':
        return (
          <div className="module-content">
            ...
            <div className="card" style={{ padding: 24 }}>
              <h3>角色列表</h3>
              <p style={{ color: 'var(--text-muted)', marginTop: 8 }}>项目角色管理，与选角中心同步</p>
              <button className="btn btn-primary" style={{ marginTop: 16 }} onClick={() => navigate('/casting')}>
                打开选角中心
              </button>
            </div>
          </div>
      ...
      case 'scene':
        return (
          <div className="module-content">
            ...
            <div className="card" style={{ padding: 24 }}>
              <h3>场景管理</h3>
              <p style={{ color: 'var(--text-muted)', marginTop: 8 }}>项目场景管理，与场景工坊同步</p>
              <button className="btn btn-primary" style={{ marginTop: 16 }} onClick={() => navigate('/scene')}>
                打开场景工坊
              </button>
            </div>
          </div>
      ...
      case 'props':
        return (
          <div className="module-content">
            ...
            <div className="card" style={{ padding: 24 }}>
              <h3>道具管理</h3>
              <p style={{ color: 'var(--text-muted)', marginTop: 8 }}>项目道具管理</p>
              <button className="btn btn-primary" style={{ marginTop: 16 }} onClick={() => navigate('/props')}>
                打开道具管理
              </button>
            </div>
          </div>
      ...
      case 'storyboard':
        return (
          <div className="module-content">
            ...
            <div className="card" style={{ padding: 24 }}>
              <h3>分镜管理</h3>
              <p style={{ color: 'var(--text-muted)', marginTop: 8 }}>项目分镜与视频生成</p>
              <button className="btn btn-primary" style={{ marginTop: 16 }} onClick={() => navigate('/storyboard')}>
                打开分镜导演台
              </button>
            </div>
          </div>
      ...
      case 'post':
        return (
          <div className="module-content">
            ...
            <div className="card" style={{ padding: 24 }}>
              <h3>后期制作</h3>
              <p style={{ color: 'var(--text-muted)', marginTop: 8 }}>视频后期处理</p>
      ...
      case 'output':
        return (
          <div className="module-content">
            ...
            <div className="card" style={{ padding: 24 }}>
              <h3>成片管理</h3>
              <p style={{ color: 'var(--text-muted)', marginTop: 8 }}>导出与输出</p>
              <button className="btn btn-primary" style={{ marginTop: 16 }} onClick={() => navigate('/output')}>
                打开成片输出
              </button>
            </div>
          </div>
    ...
    <div className="project-workspace">
      ...
      <div className="workspace-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <button className="btn" onClick={() => navigate('/')} style={{ background: 'var(--bg-input)' }}>
            ← 返回
          </button>
          <h2 style={{ margin: 0 }}>{currentProject.title}</h2>
          <span style={{ padding: '4px 12px', background: statusMap[currentProject.status].color, color: 'white', borderRadius: 20, fontSize: 12 }}>
            {statusMap[currentProject.status].label}
          </span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <span style={{ fontSize: 13, color: 'var(--text-muted)' }}>切换项目</span>
          <select
            style={{ padding: '8px 12px', background: 'var(--bg-input)', border: '1px solid var(--border)', borderRadius: 8, color: 'var(--text)' }}
      ...
      <div className="workspace-content">
        ...
        <nav className="workspace-sidebar">
          {modules.map((module) => (
            <button
              key={module.id}
              className={`workspace-nav-item ${activeModule === module.id ? 'active' : ''}`}
